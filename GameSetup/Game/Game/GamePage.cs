...
namespace Game
{
    public partial class GamePage : Form
    {
        ...
        public GamePage(string name,string level)
        {
            ...
            lblname.Text = name;
             string filePath = "F:\\My_Project\\Project\\gamepp.xlsx";
//string filePath = "https:\\drive.google.com\\drive\\u\\0\\folders\\1ITPvySpTPt9WkBC39ybguGrnVQnc2p24\\gamepp.xlsx";
           // string filePath = "https://docs.google.com/spreadsheets/d/1JOQjAosxD2whZbhfBp8-SkM32gBVLqih/edit?usp=share_link&ouid=105050555731419567729&rtpof=true&sd=true";
            //
